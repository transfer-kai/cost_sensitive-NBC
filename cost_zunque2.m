...
clear all;
clc;
file = textread('./datasets/breast-w.txt','%s','delimiter','\n','whitespace','');
[m,n]=size(file);
for i=1:m
...
for i=1:M
    ...
    if(strcmp(b1,T_class)&&strcmp(a1,F_class))
        fn=fn+1;
    end
    if(strcmp(b1,F_class)&&strcmp(a1,T_class))
        fp=fp+1;
    end
    if(strcmp(b1,F_class)&&strcmp(a1,F_class))
        tn=tn+1;
    end
    if(strcmp(a1,b1))
        p1=p1+1;
